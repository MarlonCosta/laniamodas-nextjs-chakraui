...
import { Alert, AlertIcon, Box, Input, InputGroup, InputLeftAddon, InputRightAddon, Select, Stat, StatArrow, StatGroup, StatLabel, StatNumber, Switch } from "@chakra-ui/react";
            ...
            <Box marginTop={"10px"}>
                <Box display="flex" justifyContent="space-between">
                    <InputGroup mr={2} flex="1">
                        <InputLeftAddon bg={"pink.400"} color={"white"}>Valor pago </InputLeftAddon>
                    ...
                    <InputGroup mr={2} flex="0 0 25%">
                        <InputLeftAddon bg={"pink.400"} color={"white"}>Desconto</InputLeftAddon>
                    ...
                    <StatGroup bg={"pink.400"} w={"50%"} borderRadius={"10px"} color={"white"} p={"4"}>
                        <Stat>
